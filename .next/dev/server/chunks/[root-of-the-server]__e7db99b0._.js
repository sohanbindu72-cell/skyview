...
"[project]/app/api/locations/[id]/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(request, { params }) {
    try {
        ...
        const updatedLocation = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Location$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(id, data, {
            new: true,
            runValidators: true
        });
        if (!updatedLocation) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(updatedLocation);
    } catch (error) {
...
async function DELETE(request, { params }) {
    try {
        const { id } = await params;
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
        const deletedLocation = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Location$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndDelete(id);
        if (!deletedLocation) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Location not found'
            }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e7db99b0._.js.map